...
function createCliente() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            document.getElementById("retira").value = "";
...
function updateCliente() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            getAllClientes();
            // Limpiar los campos de texto después de agregar
            document.getElementById("clientIdToUpdate").value = "";
            document.getElementById("retiraToUpdate").value = "";
            document.getElementById("direccionToUpdate").value = "";
        } else {
...
function deleteCliente() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            getAllClientes();
            // Limpiar los campos de texto después de agregar
            document.getElementById("clientIdToDelete").value = "";
        } else {
