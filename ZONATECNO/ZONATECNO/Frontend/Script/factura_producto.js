...
function updateFacturaProducto() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            getAllFacturaProducto();
            // Limpiar los campos de texto después de agregar
            document.getElementById("facturaProductoIdToUpdate").value = "";
            document.getElementById("idFacturaToUpdate").value = "";
            document.getElementById("idProductoToUpdate").value = "";
            document.getElementById("cantidadToUpdate").value = "";
        } else {
...
function deleteFacturaProducto() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            getAllFacturaProducto();
            // Limpiar los campos de texto después de agregar
            document.getElementById("facturaProductoIdToDelete").value = "";
        } else {
