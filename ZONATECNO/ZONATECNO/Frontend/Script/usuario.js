...
function updateUsuario() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            getAllUsuarios();
            // Limpiar los campos de texto después de agregar
            document.getElementById("userIdToUpdate").value = "";
            document.getElementById("nombreToUpdate").value = "";
            document.getElementById("cedulaToUpdate").value = "";
            document.getElementById("claveToUpdate").value = "";
        } else {
