...
function updateFactura() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            getAllFacturas();
            // Limpiar los campos de texto después de agregar
            document.getElementById("facturaIdToUpdate").value = "";
            document.getElementById("idClienteToUpdate").value = "";
            document.getElementById("fechaToUpdate").value = "";
        } else {
...
function deleteFactura() {
    ...
    .then(function(response) {
        if (response.ok) {
            ...
            getAllFacturas();
            // Limpiar los campos de texto después de agregar
            document.getElementById("facturaIdToDelete").value = "";
        } else {
